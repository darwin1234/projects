 ...
 $(function(){
	...
	$("#sort").on("change", function(){
		...
		$("#gatheredRecord").load("<?php echo base_url(); ?>Ushers/gathered/?gender=" + gender + "&level_in_post=7&lesson_level=4" );
	});
...
<div id="EVENT_CONTAINER" class="container" style="padding:0px; background:white;">
            ...
            <header id="form_head3">		
			<span style="float:left; width:450px;"> 
			<h2>School of Leaders 1</h2>
