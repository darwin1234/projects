 ...
 $(function(){	 
  ...
  $(function(){
	...
	$("#sort").on("change", function(){
		...
		$("#gatheredRecord").load("<?php echo base_url(); ?>Ushers/gathered/?gender=" + gender + "&level_in_post=10&lesson_level=7" );
	});
...
<div id="EVENT_CONTAINER" class="container" style="padding:0px; background:white;">
            ...
            <header id="form_head6">		
			<span style="float:left; width:450px;">
			<h2>School of Leaders 3</h2>
			...
			<span id="datatoday"><?php echo date('F jS l') ;?></span> 
					...
					<div class='btn btn-default' style="font-size:12px;">Single Men<span style="position: relative; background: rgb(255, 117, 25); padding: 2px 6px; color: rgb(255, 255, 255); font-style: normal; font-variant: normal; font-weight: bold; font-stretch: normal; font-size: 12px ; line-height: normal; font-family: Tahoma, Arial, Helvetica; border-radius: 3px; margin:5px;"><?php echo listofEnrolled($list_of_records,"Single Ladies",13,10,"Single","Female"); ?></span></div>
