 ...
 $(function(){
  ...
  $(function(){
	...
	$("#sort").on("change", function(){
		...
		$("#gatheredRecord").load("<?php echo base_url(); ?>Ushers/gathered/?gender=" + gender + "&level_in_post=6&lesson_level=3" );
	});
...
<?php  date_default_timezone_set("Asia/Taipei");  ?>
            <header id="form_head2">		
			<span style="float:left; width:450px;"> 
				<h2>Post Encounter</h2> 
		...
		<form id="search">
			...
			<input type="text" name="searchdelegate" autocomplete="off" id="searchdelegate" value="" placeholder="Search Delegate" class="form-control"/> 
