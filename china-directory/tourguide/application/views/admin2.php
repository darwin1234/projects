		...
		<div id="content">
			...
			<div id="left">
				<div id="menu">
					<div id="image_profile">
					   ...
					   <?php if(!empty($imagePIC)){ ?>
						   	<img id="test12345" src="<?php echo base_url(); ?>Welcome/userimage/<?php echo $userID; ?>" style="width:100%; margin: 0; padding: 0; padding-top: 0px; border: 5px solid #dfdfdf;">
						   
					   <?php }else{ ?>
						<img id="test12345" src="<?php echo strlen(@$photo)!= 0 ? base_url() .'images/' . $photo : 'http://massconline.com/memberpages/images/portrait_placeholder.jpg'; ?>" style="    border: 5px solid #dfdfdf; width:100%; margin:0; padding:0;">
					   <?php }?>
              ...
              <?php if(isset($settings) && $setting ='display'){?>		
					...
					<ul id="menu-events" class="closed">
						<li class="last"><a href="<?php echo base_url(); ?>Welcome/newEvent">New Event</a></li>
					</ul>
			...
			<div id="right"> 
				...
				<div class="box">
					...
					<!-- box / title -->
					<div class="title">
					<?php foreach($list_of_records as $genderFields) {
									//@$genderFieldsLabel  = $genderFields->Gender;
							//if($genderFields->Gender == $usergender){
								if($genderFields->active == 0){
									@$ALLAllMembers++;
									
								}
								
								
								if( $genderFields->Gender== "Female" && $genderFields->added_as_close_cell == 1 && $genderFields->active == 0){
									
									@$FemaleTotal++;
									
								}else{
									if($genderFields->Gender= "Male" && $genderFields->added_as_close_cell == 1 && $genderFields->active == 0){
									@$MaleTotal++;
									}
								}
							...
							if($genderFields->added_as_close_cell == 1 && $genderFields->active == 0){
											@$AllMembers++;
							}
							if($genderFields->added_as_close_cell == 1 && $genderFields->civil_status =="Married" && $Role == "Pastor" && $genderFields->active == 0){
								
								@$married++;
							}
							
							
							if($genderFields->added_as_close_cell == 1 && $genderFields->civil_status =="Single" && $Role == "Pastor" && $genderFields->active == 0){
					...
					<!--icons -->
						<h3 style="width:98%;">
						<span id="FullName" class="pull-left">
						
						<?php echo !empty($LeaderName) ?  $LeaderName : '' ?>
						
						</span>	
						
						<div id="secondNav" class="pull-right;" >
					
						<a href="#" data-toggle="modal" data-target="#single" ><span style="float:left;  margin-left:15px; margin-right:15px;"><img src="<?php echo base_url();?>avatars/single.png"></span> </a>
										...
										<div class="modal-dialog">
											...
											<div class="modal-content"  style="background:rgba(0,0,0,0.6);">
												<div class="modal-header">
													...
													<h4 class="modal-title">Single</h4>
												</div>
														  <div class="modal-body">
															<p style="font-size:80px; text-align:center; margin:60px; color:#fff;"><strong><?php echo @$Single;?></strong></p>
														  </div>
														   <div class="modal-footer">
								...
								<a href="#" data-toggle="modal" data-target="#married" ><span style="float:left; margin:0px;  margin-left:15px; margin-right:15px;"><img src="<?php echo base_url();?>avatars/married.png"></span> </a>
								<div id="married" class="modal fade" role="dialog">
										<div class="modal-dialog">
											<!-- Modal content-->
											<div class="modal-content"  style="background:rgba(0,0,0,0.6);">
												<div class="modal-header">
												
													<h4 class="modal-title">Married</h4>
												</div>
														  <div class="modal-body">
															<p style="font-size:80px; text-align:center; margin:60px; color:#fff;"><strong><?php echo @$married;?></strong></p>
														  </div>
														   <div class="modal-footer">
																<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
														   </div>
								...
								<a href="#" data-toggle="modal" data-target="#myModal_men"><span style="float:left; margin:0; margin-left:15px; margin-right:15px;"><img src="<?php echo base_url(); ?>/avatars/men.png"></span></a>
								

													<!-- Modal -->
													<div id="myModal_men" class="modal fade" role="dialog">
													  <div class="modal-dialog">
														...
														<div class="modal-content"  style="background:rgba(0,0,0,0.6);">
														  ...
														  <div class="modal-body">
															<p style="font-size:80px; text-align:center; margin: 60px; color:#fff;"><strong><?php echo @$MaleTotal; ?></strong></p>
														  </div>
														 <div class="modal-footer">
																<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
															  </div>
										...
										<a href="#" data-toggle="modal" data-target="#myModal_female"><span style="float:left; margin:0px;  margin-left:15px; margin-right:15px;"><img src="<?php echo base_url(); ?>/avatars/female.png"></span></a> 
								<!-- Modal -->
													<div id="myModal_female" class="modal fade" role="dialog">
													  <div class="modal-dialog">
														...
														<div class="modal-content"  style="background:rgba(0,0,0,0.6);">
														  <div class="modal-header">
																...
																<h4 class="modal-title">Ladies</h4>
														  </div>
														  <div class="modal-body">
															<p style="font-size:80px; text-align:center; margin:60px; color:#fff;"><strong><?php echo @$FemaleTotal; ?></strong></p>
														  </div>
														  <div class="modal-footer">
															<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
														  </div>
									...
									<a href="#" data-toggle="modal" data-target="#SuperAdminTotalNet" ><span style="float:left; margin:0;  margin-left:15px; margin-right:15px;"><img src="<?php echo base_url();?>avatars/leaders.png"></span> </a>
									
									<div id="SuperAdminTotalNet" class="modal fade" role="dialog">
										<div class="modal-dialog">
											<!-- Modal content-->
											<div class="modal-content"  style="background:rgba(0,0,0,0.6);">
												<div class="modal-header">
													<h4 class="modal-title">Close Cell</h4>
												</div>
														  <div class="modal-body">
															<p style="font-size:80px; text-align:center; margin:60px; color:#fff;"><strong><?php echo @$AllMembers;?></strong></p>
														  </div>
													 <div class="modal-footer">
															<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
														  </div>
									...
									<a href="#" data-toggle="modal" data-target="#allMembers" ><span style="float:left; margin:0;  margin-left:15px; margin-right:15px;"><img src="<?php echo base_url();?>avatars/all.png"></span> </a>
								
								
									<div id="allMembers" class="modal fade" role="dialog">
										<div class="modal-dialog">
											<!-- Modal content-->
											<div class="modal-content" style="background:rgba(0,0,0,0.6);">
												<div class="modal-header">
													<h4 class="modal-title">Church Members</h4>
												</div>
														  <div class="modal-body">
															<p style="font-size:80px; text-align:center; margin:60px; color:#fff;"><strong><?php echo @$ALLAllMembers;?></strong></p>
														  </div>
													 <div class="modal-footer" style="color:#fff; border:0;">
															<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
														  </div>
											</div>
									...
									<?php if($Role == "Pastor") { ?>
											<a  href="#" data-toggle="modal" data-target="#myModal"><span style="float:left;  margin-left:15px; margin-right:15px;"><img src='<?php echo base_url(); ?>avatars/search_icon.png'></span></a>
									<?php } ?>
						</div>
					...
					<div class="table">
						...
						<table>
							<thead>
								<tr>
									<th>My Primary 12</th>
									<th style="text-align:center;">G12</th>
									<th style="text-align:center;">Total Network</th>
					...
					<?php 
						...
						$progress144 = $progress[0];
						$progress1728 = $progress[1];
						
						$progress144Percent = floor(($progress144 / (144 * 2)) * 100);
						$progress1728Percent = floor(($progress1728 / (1728 * 2)) * 100);
						
						/*
						$progressCounter_144 = 0; 
						$progressCounter_3456 = 0;
						$countMem_144 = 0;
						$countMem_1728 = 0;
						foreach($list_of_records as $progress){
								
								if($progress->added_as_close_cell == 1 && $progress->role == 144 && $progress->active == 0){
									$progressCounter_144++;
									$countMem_144++;
								}
								
									if($progress->added_as_close_cell == 1 && $progress->role == 1728){
									$progressCounter_3456++;
									$countMem_1728++;
								}
						
						}
						$progressCounter_114 	= 288/$progressCounter_144;
						$progressCounter_1728 	= 3456/$progressCounter_3456;
						*/
					?>
				<div  id="progresswrapper" >
						<h2 style="text-align:center; color:#4DB53C; margin-bottom:30px;">Progress</h2>
						<div style="float:left; width:45%;">
						
							<div style="margin: auto;" class="c100 p<?php echo $progress144Percent; ?> big">
								<span>
								<?php echo $progress144Percent; ?>%
									<p style="font-size:10px; clear:both;"><?php echo $progress144; ?> souls</p>
								</span> 
							...
							<h4 style="text-align:center; clear:both;"><?php echo floor(288- $progress144); ?> more souls to complete 144</h4>
						
						</div>
						
						<div style="float:right; width:45%;">
						
							<div style="margin: auto;" class="c100 p<?php echo $progress1728Percent; ?> big green">
								<span>
								<?php echo $progress1728Percent; ?>%
									<p style="font-size:10px; clear:both;"><?php echo $progress1728; ?> souls</p>
								</span>
							...
							<h4 style="text-align:center;  clear:both; "><?php echo floor(3456- $progress1728); ?> more souls to complete 1728</h4>
						</div>
