...
<div class="container" id="VIPFORM" style="background:white; padding:0;">
	 ...
	 <form id="seachUpdate" class="container seachUpdate" style="display:block;" >
		<div id="" class="form-group">
		 ...
		 <div id="second_third_fourth" style="display:none;">
				<div class="form-group" style="margin-bottom:0;">
				  ...
				  <input type='hidden' name="datevisited" id="datevisited" class="datevisited" value="<?php echo date("j/n/Y"); ?>">
  ...
  <form id="usherForm" class="container usherForm">
		<div id="" class="form-group">
		...
		<div id="first_time_form">
		 <div class="col-md-6" style="padding:0;">
			...
			<div class="form-group">
			  ...
			  <input type="text"  name="contact" autocomplete="off"  onkeypress="usher.validationCP();" id= autocomplete="off" class="form-control contact" id="contact" placeholder="Must be 11 digit if cellphone number, ex. 09101234567">
			  <div class="CpValidation" style="margin-left:20px;"></div>
			</div>

			<!--<div class="form-group" style="width:100%; clear:both;">
			  <label for="contact">Facebook Account</label>
			  <input type="text"  name="contact" autocomplete="off"  onkeypress="usher.validationCP();" id= autocomplete="off" class="form-control contact" id="contact" placeholder="Facebook Username">
			  <div class="CpValidation" style="margin-left:20px;"></div>
			</div>-->
			...
			<div class="form-group">
			 ...
			 <div class="form-group" style="width:100%; clear:both;">
						...
						<div class="form-group">
								...
								style="margin-right:30px; margin-bottom:20px; margin-top: 20px; border-radius: inherit;">
						</div>
				 </div>
