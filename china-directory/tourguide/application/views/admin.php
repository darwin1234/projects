		...
		<div id="content">
			...
			<div id="left">
				...
				<?php if(isset($settings) && $setting ='display'){?>		
					<h6 id="h-menu-events"><a href="<?php echo base_url(); ?>Welcome/eventspage"><span>Dashboard</span></a></h6>
					...
					<h6 id="h-menu-settings"><a href="#settings"><span>Business Lists</span></a></h6>
