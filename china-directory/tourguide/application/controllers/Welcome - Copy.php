...
class Welcome extends CI_Controller {
	...
	public function disciples($userID){
		...
		$this->load->view('headers/g12Networkheader',$data);
		$this->load->view('deciplesprofile',$data);
		$this->load->view('footers/g12Networkfooter',$data);	
	...
	public function AddRecords(){
			...
			$accountID				= $this->input->post('GetID');
			$username				= $this->input->post('discipleUsername');
			$password				= md5($this->input->post('disciplePassword'));
			$retypepassword			= md5($this->input->post('retypedisciplePassword'));
			...
			if(!empty($_POST)){
					...
					$this->desciples->insertRecords($username,$password,$retypepassword,$accountID,$userRole);
	...
	*/
	...
	public function transferto(){
		...
		$this->desciples->transferto($iduser,$his_id,$userRole);
